...
__all__ = [
    "EfficientViTSeg",
    "efficientvit_seg_b0",
    "efficientvit_seg_b0_demo",
    "efficientvit_seg_b1",
    "efficientvit_seg_b1_demo",
    "efficientvit_seg_b2",
    "efficientvit_seg_b3",
...
def efficientvit_seg_b0_demo(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.efficientvit.backbone import efficientvit_backbone_b0_demo
    backbone = efficientvit_backbone_b0_demo(**kwargs)
...
def efficientvit_seg_b1_demo(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.efficientvit.backbone import efficientvit_backbone_b1_demo
    backbone = efficientvit_backbone_b1_demo(**kwargs)
